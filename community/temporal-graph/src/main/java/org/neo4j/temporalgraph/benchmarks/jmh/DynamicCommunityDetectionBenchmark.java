...
public class DynamicCommunityDetectionBenchmark {
    ...
    @Benchmark
    public void testLabelRank(Blackhole blackhole) throws IOException {
    ...
    @Benchmark
    public void testIncrementalLabelRank(Blackhole blackhole) throws IOException {
        var step = operations / snapshots;
        long timestamp = step;
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(DynamicCommunityDetectionBenchmark.class.getSimpleName())
