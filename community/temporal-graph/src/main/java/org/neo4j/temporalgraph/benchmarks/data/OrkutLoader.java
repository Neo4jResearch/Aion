...
public class OrkutLoader extends GraphLoader {
    public static final String DEFAULT_PATH = DATASET_FOLDER + "/orkut-links/out.orkut-links";

    public OrkutLoader(String stringPath) {
        super(stringPath, "ORKUT");
    }
