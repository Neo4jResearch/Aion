...
import org.neo4j.temporalgraph.lineageindex.entitystores.disk.PersistentNodeStore;
...
public class PersistentLineageStore implements LineageStore {
    ...
    public PersistentLineageStore(
        ...
        nodeStore = new PersistentNodeStore(pageCache, fs, nodeIndexPath, namesToIds, idsToNames);
        relationshipStore =
                new PersistentDoubleListRelationshipStore(pageCache, fs, relIndexPath, namesToIds, idsToNames);
    }
