...
public class WebTrackerLoader extends BipartiteGraphLoader {
    public static final String DEFAULT_PATH = DATASET_FOLDER + "/trackers/out.trackers";

    private static final int LIMIT = 20_000_000;

    public WebTrackerLoader(String stringPath) {
        super(stringPath, "WebTracker");
    }
