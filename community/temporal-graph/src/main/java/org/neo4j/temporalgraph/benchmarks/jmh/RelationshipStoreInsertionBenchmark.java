...
public class RelationshipStoreInsertionBenchmark {
    ...
    @Benchmark
    public void testInsertions(Blackhole blackhole) throws IOException {
        for (int i = 0; i < operations; ++i) {
            store.addRelationship(relationshipList.get(i));
        }
        // debug = String.format("Rels: %d, Neighbourhood records: %d",store.numberOfRelationships(),
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(RelationshipStoreInsertionBenchmark.class.getSimpleName())
