...
class InMemoryTimeStoreTests {
    ...
    void shouldReturnCorrectNodes() throws IOException {
        ...
        var store = new InMemoryTimeStore(policy);
    ...
    @Test
    void shouldExpandNodeForMultipleHopsDirected() {
        // Create a store and add nodes
        var policy = new SnapshotCreationPolicy(5);
        var store = new InMemoryTimeStore(policy);
    ...
    @Test
    void shouldReturnRelationshipsBasedOnTime() {
    ...
    @Test
    void shouldReturnRelationshipHistory() {
        var policy = new SnapshotCreationPolicy(5);
        var store = new InMemoryTimeStore(policy);
    ...
    @Test
    void shouldReturnNeighbourhoodHistory() {
        var policy = new SnapshotCreationPolicy(5);
        var store = new InMemoryTimeStore(policy);
