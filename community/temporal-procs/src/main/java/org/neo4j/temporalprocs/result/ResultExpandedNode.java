...
public class ResultExpandedNode {
    ...
    public ResultExpandedNode(long startTime, long hop, long nodeId, List<String> labels, List<Property> properties) {
    ...
    public boolean equals(Object obj) {
        ...
        final ResultExpandedNode other = (ResultExpandedNode) obj;
        if (this.nodeId != other.nodeId || this.timestamp != other.timestamp || this.hop != other.hop) {
            return false;
        }
